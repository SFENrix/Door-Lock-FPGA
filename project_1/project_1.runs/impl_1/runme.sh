...
HD_PWD='C:/Users/TUF/Desktop/Kuliah/SEM 3/DIG SYS/TR2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lock.tcl -notrace
