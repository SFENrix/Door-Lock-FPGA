...
HD_PWD='C:/Users/TUF/Desktop/Kuliah/SEM 3/DIG SYS/TR2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lock.tcl
